...
Изначально при измении hostname при перезапуске оно сбрасывалось к изначальному, нужно было поменять файл /etc/cloud/cloud.cfg,
...
не вижу смысла в создании пользователя student: berry, как по мне, веселее выглядит и связано с названием
