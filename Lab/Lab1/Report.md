...
![system info 1](screenshots/03-system-info-1)
![system info 2](screenshots/03-system-info-2)
![system info 3](screenshots/03-system-info-3)
...
_вывод `dpkg -l | grep -E 'openssh|python|git|curl|vim|nano'`_
